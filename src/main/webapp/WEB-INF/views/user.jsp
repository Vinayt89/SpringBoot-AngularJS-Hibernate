...
<html>
  <head>  
    <title>SpringBoot-Angular-Hibernate Example</title>  
    <style>
      .username.ng-valid {
	...
	<link rel="icon" type="image/png" href="/app/images/angular.png" sizes="32*32"/>
  </head>
                          ...
                          <div class="form-group col-md-12">
                              ...
                              <div class="col-md-7">
                                  ...
                                  <div class="has-error" ng-show="myForm.$dirty">
                                      ...
                                      <span ng-show="myForm.uname.$invalid">Invalid Email Address!</span>
                                  </div>
                              </div>
                          </div>
                      </div>
